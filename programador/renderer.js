...
/* document.getElementById("target-file").value = "/home/climo-nuc/CLIMO_Pagina_ConfiguracionCLIMO/components/include/secrets.h"
readTargetFile("/home/climo-nuc/CLIMO_Pagina_Configuracion/CLIMO/components/include/secrets.h") */
...
document.getElementById('select-target-file').addEventListener('click', function () {
    dialog.showOpenDialog(function (fileNames) {
        if (fileNames === undefined) {
            var targetPath = "/home/climo-nuc/CLIMO_Pagina_Configuracion/CLIMO/components/include/secrets.h"
    ...
    if (this.value && document.getElementById("actual-file").value) {
        ...
        if (checkExist.every(item => item === false)) {
            ...
            if (document.getElementById("target-file").value) {
                ...
                var spiffsPath = "/home/climo-nuc/CLIMO_Pagina_Configuracion/spiffs_image"
                var sdkConfigPath = "/home/climo-nuc/CLIMO_Pagina_Configuracion/sdkconfig"
